...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(NumerosPrimosEnteros(ArrayDeBooleans(12)));
        DescomposicionFactorial(40);
        System.out.println(Final("hola que estas hola tal","que"));
    ...
    //ejercicio 2
    public static void descomposicioFactorial (int nDescomponer) {
    int nDescomponer = 50;
        for (int i = 2; i < 31; i++) {
            while (nDescomponer % 2 == 0) {
                System.out.println(nDescomponer / 2);
            }
        }
    }
    ...
    public static boolean textConteStringALaPosicio (String text, String paraulaACercar, int pos) {
        ...
        String paraulaACercar = "mon";
        int pos = 5;
            if (pos == paraulaACercar) {
                return true;
            }
            return false;
    }
